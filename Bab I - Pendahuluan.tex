...
Rumusan Masalah berisi masalah utama yang dibahas dalam tesis. Rumusan masalah yang baik memiliki struktur sebagai berikut:
\begin{enumerate}
...
\end{enumerate}
Hindari penulisan rumusan masalah yang terlalu umum atau terlalu luas cakupannya sehingga sulit untuk diselesaikan dalam jangka waktu pelaksanaan tesis, 
seperti:
\begin{enumerate}
...
Tuliskan batasan-batasan yang diambil dalam pelaksanaan tesis. Batasan ini dapat dihindari (bersifat opsional, tidak perlu ada) jika topik atau judul tesis dibuat cukup spesifik.

% --- Metodologi Pengerjaan TA ---
\section{Metodologi}
Tuliskan semua tahapan yang akan dilalui selama pelaksanaan tesis. 
Tahapan ini spesifik untuk menyelesaikan persoalan tesis. 
Berikut adalah contoh metodologi pengerjaan tesis yang dapat diikuti, yaitu meliputi tahapan, langkah-langkah, 
