...
Menurut \textcite{saewong2002}, Subbab ini \autocite{saewong2002} menjelaskan dasar pemikiran, motivasi, kebutuhan, alasan, atau urgensi pemilihan masalah tugas akhir. Subbab ini berisi penjelasan ringkas tentang kondisi atau situasi yang ada saat ini terkait dengan topik yang dibahas. Tujuan utamanya adalah untuk memberikan informasi secukupnya kepada pembaca agar memahami topik yang akan dibahas. Dalam subbab ini, jelaskan hal-hal berikut ini:
\begin{enumerate}
...
Subbab ini berisi masalah utama yang dibahas dalam tugas akhir. Perumusan masalah yang baik memiliki struktur sebagai berikut:
\begin{enumerate}
...
\end{enumerate}
Hindari penulisan masalah yang terlalu umum atau terlalu luas cakupannya sehingga sulit untuk diselesaikan dalam jangka waktu pelaksanaan tugas akhir, 
seperti:
\begin{enumerate}
...
Tuliskan ruang lingkup, asumsi, dan batasan-batasan yang diambil dalam pelaksanaan tugas akhir. Batasan ini dapat dihindari (bersifat opsional, tidak perlu ada) jika topik atau judul tugas akhir dibuat cukup spesifik.

\section{Hipotugas akhir}
Tuliskan hipotugas akhir yang akan diuji dalam pelaksanaan tugas akhir. 
Hipotugas akhir ini merupakan pernyataan yang dapat diuji kebenarannya melalui proses pelaksanaan tugas akhir, 
terutama pada tahap evaluasi. Hipotugas akhir yang baik memiliki karakteristik sebagai berikut:
\begin{enumerate}
    \item Spesifik: Hipotugas akhir harus jelas dan spesifik, sehingga dapat diuji dengan cara yang terukur.
    \item Terukur: Hipotugas akhir harus dapat diuji dengan data atau informasi yang dapat diukur, sehingga dapat dinilai kebenarannya.
    \item Relevan: Hipotugas akhir harus relevan dengan topik tugas akhir dan dapat memberikan kontribusi yang signifikan terhadap penyelesaian masalah yang dibahas.
    \item Dapat diuji: Hipotugas akhir harus dapat diuji melalui proses pelaksanaan tugas akhir, terutama pada tahap evaluasi, sehingga dapat dinilai kebenarannya.
\end{enumerate}

Hipotugas akhir diperoleh dari premis-premis yang ada pada latar belakang dan rumusan masalah. 
Oleh karena itu, tuliskan dulu premis-premis yang menentukan hipotugas akhir tersebut sebelum menuliskan hipotugas akhirnya.



% --- Metodologi Pengerjaan TA ---
\section{Metodologi}
Tuliskan semua tahapan spesifik yang akan dilalui selama pelaksanaan tugas akhir. 
Ada beberapa pendekatan metodologi yang dapat digunakan dalam pelaksanaan tugas akhir sesuai dengan topik yang dibahas, 
...
Secara umum,  metodologi pengerjaan tugas akhir meliputi tahapan, langkah-langkah, atau tata cara melakukan:
\begin{enumerate}
...
\item   Penarikan kesimpulan dan saran berdasarkan hasil pelaksanaan tugas akhir berdasarkan hasil evaluasi.   
