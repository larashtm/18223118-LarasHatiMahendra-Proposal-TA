...
Subbab ini menjelaskan dasar pemikiran, motivasi, kebutuhan, alasan, atau urgensi pemilihan masalah tesis. Subbab ini berisi penjelasan ringkas tentang kondisi atau situasi yang ada saat ini terkait dengan topik yang dibahas. Tujuan utamanya adalah untuk memberikan informasi secukupnya kepada pembaca agar memahami topik yang akan dibahas. Dalam subbab ini, jelaskan hal-hal berikut ini:
\begin{enumerate}
...
\item   Kelemahan atau kekurangan dari solusi yang telah diterapkan atau yang memungkinkan untuk diterapkan tersebut, yang menjadi dasar pemikiran dalam merumuskan masalah tesis.
\end{enumerate}
Penulisan latar belakang masalah yang baik akan mengantarkan pembaca kepada pemahaman yang jelas tentang topik yang akan dibahas, 
sehingga pembaca dapat mengikuti pembahasan pada bab atau subbab berikutnya dengan baik. Oleh karena itu, 
...
Penjelasan hasil studi literatur yang komprehensif dapat dijabarkan di Bab II secara sistematis.

Dalam menulis latar belakang, hindari penulisan yang bersifat terlalu umum atau terlalu luas cakupannya sehingga sulit untuk dihubungkan dengan topik yang dibahas dalam tesis,
seperti:
\begin{enumerate}
...
\end{enumerate}
Penulisan yang terlalu umum atau luas cakupannya akan menyulitkan penulis dalam merumuskan masalah, tujuan, metodologi, dan evaluasi tesis.
...
Subbab ini berisi masalah utama yang dibahas dalam tesis. Perumusan masalah yang baik memiliki struktur sebagai berikut:
\begin{enumerate}
...
\end{enumerate}
Hindari penulisan masalah yang terlalu umum atau terlalu luas cakupannya sehingga sulit untuk diselesaikan dalam jangka waktu pelaksanaan tesis, 
seperti:
\begin{enumerate}
...
\end{enumerate}
Rumusan masalah yang baik dan spesifik akan memudahkan penulis dalam menentukan tujuan, metodologi, dan evaluasi tesis.

Selain itu, hindari menuliskan pertanyaan yang merupakan sebuah keniscayaan yang harus dijawab atau dikerjakan 
dalam pelaksanaan tesis, seperti:
\begin{enumerate}
...
\end{enumerate}
Kegiatan analisis, perancangan, implementasi, dan pengujian merupakan tahapan yang harus dilakukan dalam pelaksanaan tesis,
sehingga pertanyaan-pertanyaan tersebut tidak perlu dimasukkan ke dalam rumusan masalah.

% --- Tujuan ---
\section{Tujuan}
Tuliskan \textbf{tujuan utama} dan/atau tujuan detail yang akan dicapai dalam pelaksanaan tesis. 
Fokuskan isi subbab ini pada hasil akhir yang ingin diperoleh setelah tesis diselesaikan 
...
di akhir pelaksanaan tesis. Oleh karena itu, tuliskan juga \emph{kriteria keberhasilan} tesis ini.

% --- Batasan Masalah ---
\section{Ruang Lingkup, Asumsi, dan Batasan Masalah}
Tuliskan ruang lingkup, asumsi, dan batasan-batasan yang diambil dalam pelaksanaan tesis. Batasan ini dapat dihindari (bersifat opsional, tidak perlu ada) jika topik atau judul tesis dibuat cukup spesifik.

\section{Hipotesis}
Tuliskan hipotesis yang akan diuji dalam pelaksanaan tesis. 
Hipotesis ini merupakan pernyataan yang dapat diuji kebenarannya melalui proses pelaksanaan tesis, 
terutama pada tahap evaluasi. Hipotesis yang baik memiliki karakteristik sebagai berikut:
\begin{enumerate}
    \item Spesifik: Hipotesis harus jelas dan spesifik, sehingga dapat diuji dengan cara yang terukur.
    \item Terukur: Hipotesis harus dapat diuji dengan data atau informasi yang dapat diukur, sehingga dapat dinilai kebenarannya.
    \item Relevan: Hipotesis harus relevan dengan topik tesis dan dapat memberikan kontribusi yang signifikan terhadap penyelesaian masalah yang dibahas.
    \item Dapat diuji: Hipotesis harus dapat diuji melalui proses pelaksanaan tesis, terutama pada tahap evaluasi, sehingga dapat dinilai kebenarannya.
\end{enumerate}

Hipotesis diperoleh dari premis-premis yang ada pada latar belakang dan rumusan masalah. 
Oleh karena itu, tuliskan dulu premis-premis yang menentukan hipotesis tersebut sebelum menuliskan hipotesisnya.
...
Secara umum,  metodologi pengerjaan tesismeliputi tahapan, langkah-langkah, atau tata cara melakukan:
\begin{enumerate}
...
\item   Penarikan kesimpulan dan saran berdasarkan hasil pelaksanaan tesis. Hasil kesimpulan dan saran ini akan dijelaskan secara rinci di Bab VII Kesimpulan dan Saran. 
...
Tuliskan gambaran umum isi dari setiap bab yang ada dalam laporan tesis. Sistematika penulisan ini memberikan panduan bagi pembaca tentang struktur dan alur pembahasan dalam laporan tesis. Berikut adalah contoh sistematika penulisan yang dapat diikuti:
\begin{enumerate}
\item	Bab I Pendahuluan: Berisi latar belakang, rumusan masalah, tujuan, batasan masalah, metodologi, dan sistematika penulisan laporan tesis       .
\item	Bab II Studi Literatur: Berisi kajian pustaka yang relevan dengan topik tesis, termasuk teori-teori, konsep-konsep, dan hasil-hasil penelitian sebelumnya yang                mendukung pelaksanaan tesis.
\item	Bab III Analisis dan Desain: Berisi penjelasan tentang analisis masalah dan kebutuhan pengguna serta berbagai alternatif solusinya.
...
\item   Bab VII Kesimpulan dan Saran: Berisi kesimpulan dari hasil pelaksanaan tesis dan saran untuk pengembangan lebih lanjut.
