...
% Versi 1.1
%
% Template Tesis untuk Program Magister Informatika
...
%
% Petunjuk penggunaan:
% 1. Ada 2 file utama, yaitu Tesis.tex (file ini) dan daftar-pustaka.bib (file daftar pustaka).
% 2. Sunting Tesis.tex sesuai dengan kebutuhan Anda.
...
% 5. Kompilasi file Tesis.tex menggunakan XeLaTeX dan Biber (lihat urutan cara kompilasi di bawah).
% 6. Hasil kompilasi adalah file Tesis.pdf yang siap dicetak.
% 
...
% - Selamat menyusun dokumen tesis Anda!
%
...
\setlength{\cftchapnumwidth}{4.4em}
\setlength{\cftsecindent}{1.6em} % 2.2
\setlength{\cftsecnumwidth}{2.8em} % 2.8
\setlength{\cftsubsecindent}{4.4em} % 5 cftsubsecindent = cftsecindent + cftsecnumwidth, agar nomor subbab sejajar dengan nomor bab di daftar isi
\setlength{\cftsubsecnumwidth}{3.2em} % 3.2
\setlength{\cftsubsubsecindent}{7.6em} % 8.2
\setlength{\cftsubsubsecnumwidth}{3.2em} % 3.2
...
\settowidth{\cftchapnumwidth}{BAB~12\quad}
...
\input{3a Pernyataan Penggunaan AI.tex}
\input{4 Abstrak.tex}
...
\input{7 Daftar Gambar.tex}
\input{8 Daftar Tabel.tex}
\input{9 Daftar Persamaan.tex}
...
\input{Bab III - Analisis dan Desain.tex}


%\input{Bab IV - Implementasi.tex}
...
%\settowidth{\cftchapnumwidth}{A\quad}
...
\addtocontents{toc}{\protect\settowidth{\protect\cftchapnumwidth}{A\quad}}
